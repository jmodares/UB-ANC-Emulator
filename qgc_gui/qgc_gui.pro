...
DEFINES += MAVLINK_COMM_NUM_BUFFERS=256

DEFINES += MAV_DATA_STREAM_RAW_SENSORS_RATE=1
DEFINES += MAV_DATA_STREAM_EXTENDED_STATUS_RATE=1
DEFINES += MAV_DATA_STREAM_RC_CHANNELS_RATE=1
DEFINES += MAV_DATA_STREAM_POSITION_RATE=3
DEFINES += MAV_DATA_STREAM_EXTRA1_RATE=10
DEFINES += MAV_DATA_STREAM_EXTRA2_RATE=1
DEFINES += MAV_DATA_STREAM_EXTRA3_RATE=1
